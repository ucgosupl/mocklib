...
TEST(mocks, mode_basic_no_args_ret)
{
    ...
    retval = 1;
    dep_module1_mock_dep_no_args_ret_config(MOCKLIB_MODE_BASIC, retval);
...
TEST(mocks, mode_basic_one_arg_ret)
{
    ...
    retval = 6;
    arg1 = 7;
    dep_module1_mock_dep_one_arg_ret_config(MOCKLIB_MODE_BASIC, retval);
...
TEST(mocks, mode_basic_more_args_ret)
{
    ...
    arg1 = 10;
    arg2 = 11;
    dep_module1_mock_dep_more_args_ret_config(MOCKLIB_MODE_BASIC, retval);
...
TEST(mocks, mode_trace_one_arg_no_ret_unexpected)
{
    uint16_t arg1;
...
TEST(mocks, mode_trace_one_arg_no_ret_expect_single_call)
{
    uint16_t arg1;
...
TEST(mocks, mode_trace_one_arg_no_ret_expect_many_calls)
{
    uint16_t arg1;
    int32_t call_cnt;
    int32_t i;
...
TEST(mocks, mode_trace_one_arg_no_ret_wrong_arg1)
{
    uint16_t arg1;
...
TEST(mocks, mode_trace_more_args_no_ret_unexpected)
{
    int32_t arg1;
    uint8_t arg2;
...
TEST(mocks, mode_trace_more_args_no_ret_expect_single_call)
{
    int32_t arg1;
    uint8_t arg2;
...
TEST(mocks, mode_trace_more_args_no_ret_expect_many_calls)
{
    int32_t arg1;
    uint8_t arg2;
    int32_t call_cnt;
...
TEST(mocks, mode_trace_more_args_no_ret_wrong_arg1)
{
    int32_t arg1;
    uint8_t arg2;
...
TEST(mocks, mode_trace_more_args_no_ret_wrong_arg2)
{
    int32_t arg1;
    uint8_t arg2;
...
TEST(mocks, mode_trace_one_arg_ret_unexpected)
{
    uint32_t arg1;
...
TEST(mocks, mode_trace_one_arg_ret_expect_single_call)
{
    uint32_t arg1;
    uint32_t ret;
...
TEST(mocks, mode_trace_one_arg_ret_expect_many_calls)
{
    uint32_t arg1;
    uint32_t ret;
    int32_t call_cnt;
...
TEST(mocks, mode_trace_one_arg_ret_wrong_arg1)
{
    uint32_t arg1;
    uint32_t ret;
...
TEST(mocks, mode_trace_more_args_ret_unexpected)
{
    int8_t arg1;
    int16_t arg2;
...
TEST(mocks, mode_trace_more_args_ret_expect_single_call)
{
    int8_t arg1;
    int16_t arg2;
    int8_t ret;
...
TEST(mocks, mode_trace_more_args_ret_expect_many_calls)
{
    int8_t arg1;
    int16_t arg2;
    int8_t ret;
...
TEST(mocks, mode_trace_more_args_ret_wrong_arg1)
{
    int8_t arg1;
    int16_t arg2;
    int8_t ret;
...
TEST(mocks, mode_trace_more_args_ret_wrong_arg2)
{
    int8_t arg1;
    int16_t arg2;
    int8_t ret;
...
TEST(mocks, mode_trace_call_no_args_no_ret_when_expected_other)
{
...
TEST(mocks, mode_trace_call_no_args_ret_when_expected_other)
{
    /* Function under test only configured to trace mode - not expected to be called. */
    dep_module1_mock_dep_no_args_ret_config(MOCKLIB_MODE_TRACE, 0);
...
TEST(mocks, mode_trace_call_one_arg_no_ret_when_expected_other)
{
    uint16_t arg1;
...
TEST(mocks, mode_trace_call_more_args_no_ret_when_expected_other)
{
    int32_t arg1;
    uint8_t arg2;
...
TEST(mocks, mode_trace_call_one_arg_ret_when_expected_other)
{
    uint32_t arg1;
...
TEST(mocks, mode_trace_call_more_args_ret_when_expected_other)
{
    int8_t arg1;
    int16_t arg2;
