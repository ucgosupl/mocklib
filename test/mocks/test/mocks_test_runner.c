...
{
    RUN_TEST_CASE(mocks_callback, no_args_no_ret_fail_when_wrong_mode_passed_to_cb_config);
    RUN_TEST_CASE(mocks_callback, no_args_no_ret_cb_called);

    RUN_TEST_CASE(mocks_callback, no_args_ret_fail_when_wrong_mode_passed_to_cb_config);
    RUN_TEST_CASE(mocks_callback, no_args_ret_cb_called);
    RUN_TEST_CASE(mocks_callback, no_args_ret_retval);

    RUN_TEST_CASE(mocks_callback, one_arg_no_ret_fail_when_wrong_mode_passed_to_cb_config);
    RUN_TEST_CASE(mocks_callback, one_arg_no_ret_cb_called);
    RUN_TEST_CASE(mocks_callback, one_arg_no_ret_args);

    RUN_TEST_CASE(mocks_callback, more_args_no_ret_fail_when_wrong_mode_passed_to_cb_config);
    RUN_TEST_CASE(mocks_callback, more_args_no_ret_cb_called);
    RUN_TEST_CASE(mocks_callback, more_args_no_ret_args);

    RUN_TEST_CASE(mocks_callback, one_arg_ret_fail_when_wrong_mode_passed_to_cb_config);
    ...
    RUN_TEST_CASE(mocks_callback, more_args_ret_fail_when_wrong_mode_passed_to_cb_config);
